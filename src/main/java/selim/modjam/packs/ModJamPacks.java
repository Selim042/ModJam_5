...
public class ModJamPacks {
	...
	public void init(FMLInitializationEvent event) {
		...
		// if (!(item instanceof ItemArmor) || ((ItemArmor) item).armorType !=
		...
		// new ResourceLocation(MODID, item.getRegistryName().getResourcePath()
		// + "_backpack"),
		// new ResourceLocation(MODID, "backpack"), new ItemStack(nbt),
		// Ingredient.fromItem(item), Ingredient.fromStacks(new
		// ItemStack(Blocks.CHEST)));
		// }
	}
