...
public class MessageOpenUpgrades implements IMessage {
	...
	public static class Handler implements IMessageHandler<MessageOpenUpgrades, IMessage> {

		@Nullable
		@Override
		public final IMessage onMessage(final MessageOpenUpgrades message, final MessageContext ctx) {
